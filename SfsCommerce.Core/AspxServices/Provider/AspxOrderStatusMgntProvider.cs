   ...
   public class AspxOrderStatusMgntProvider
    {
       ...
       public static List<OrderStatusListInfo> GetAllStatusList(int offset, int limit, AspxCommonInfo aspxCommonObj, string orderStatusName, System.Nullable<bool> isActive)
       {
           try
           {
               ...
               List<OrderStatusListInfo> lstOrderStat = sqlH.ExecuteAsList<OrderStatusListInfo>("usp_Aspx_GetOrderAliasStatusList", parameter);
               return lstOrderStat;
           }
           catch (Exception e)
           {
       ...
       public static List<OrderStatusListInfo> AddUpdateOrderStatus(AspxCommonInfo aspxCommonObj, SaveOrderStatusInfo SaveOrderStatusObj)
       {
           try
           {
               ...
               OracleHandler sqlH = new OracleHandler();
               List<OrderStatusListInfo> lstOrderStat = sqlH.ExecuteAsList<OrderStatusListInfo>("usp_Aspx_OrderStatusAddUpdate", parameter);
               return lstOrderStat;
           }
           catch (Exception e)
           {
        ...
        public static OrderStatusListInfo GetOrderStatusDetailByOrderStatusID(AspxCommonInfo aspxCommonObj,int OrderStatusID)
       {
           try
           {
               ...
               OracleHandler sqlH = new OracleHandler();
               OrderStatusListInfo lstOrderStat = sqlH.ExecuteAsObject<OrderStatusListInfo>("usp_Aspx_GetOrderStatusDetailByOrderStatusID", parameter);
               return lstOrderStat;
           }
           catch (Exception e)
           {
       ...
       public static void DeleteOrderStatusByID(int orderStatusID, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               OracleHandler sqlH = new OracleHandler();
               sqlH.ExecuteNonQuery("usp_Aspx_DeleteOrderStatusByID", parameterCollection);
           }
           catch (Exception e)
           {
               throw e;
       ...
       public static void DeleteOrderStatusMultipleSelected(string orderStatusIDs, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               OracleHandler sqlH = new OracleHandler();
               sqlH.ExecuteNonQuery("usp_Aspx_DeleteOrderStatusMultipleSelected", parameterCollection);
           }
           catch (Exception e)
           {
               throw e;
       ...
       public static bool CheckOrderStatusUniqueness(AspxCommonInfo aspxCommonObj, int orderStatusId, string orderStatusAliasName)
       {
           try
           {
               ...
               bool isUnique= sqlH.ExecuteNonQueryAsBool("usp_Aspx_CheckOrderStatusUniquness", Parameter, "IsUnique");
               return isUnique;
           }
           catch (Exception e)
           {
