   ...
   public class AspxUserDashProvider
    {
       ...
       public static List<ShareWishListItemInfo> GetAllShareWishListItemMail(int offset, int limit, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               List<ShareWishListItemInfo> lstShareWishItem= sqlH.ExecuteAsList<ShareWishListItemInfo>("usp_Aspx_GetShareWishListMailDetailGrid", parameter);
       ...
       public static List<ShareWishListItemInfo> GetShareWishListItemByID(int sharedWishID, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               OracleHandler sqlH = new OracleHandler();
               List<ShareWishListItemInfo> lstShareWishItem= sqlH.ExecuteAsList<ShareWishListItemInfo>("usp_Aspx_GetShareWishListByID", parameter);
               return lstShareWishItem;
           }
           catch (Exception e)
           {
       ...
       public static List<AddressInfo> GetUserAddressDetails(AspxCommonInfo aspxCommonObj)
       {
           ...
           List<AddressInfo> lstAddress = sqlh.ExecuteAsList<AddressInfo>("usp_Aspx_GetUserAddressBookDet", parameter);
           return lstAddress;
       }
