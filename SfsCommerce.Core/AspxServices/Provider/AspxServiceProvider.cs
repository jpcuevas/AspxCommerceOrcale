   ...
   public class AspxServiceProvider
    {
       ...
       public static void SaveServiceItem(AspxCommonInfo aspxCommonObj, int categoryId, List<ServiceItemInfo> serviceInfo, OracleTransaction tran)
       {
           try
           {
               ...
               foreach (var serviceItemInfo in serviceInfo)
               {
                   ...
                   var serviceInfoId = sqlH.ExecuteNonQuery(tran, CommandType.StoredProcedure, "usp_Aspx_AddServicesItem", parameter, "ServiceItemID");
                   ...
                   foreach (var employeeDataInfo in serviceItemInfo.EmployeeData)
                   {
                       ...
                       var serviceAssinEmployeeId = sqlH.ExecuteNonQuery(tran, CommandType.StoredProcedure, "usp_Aspx_AddServicesItem", parameter, "serviceEmployeeID");
                       ...
                       foreach (var serviceDateInfo in employeeDataInfo.AvailableDate)
                       {
                           ...
                           parameter.Add(new KeyValuePair<string, object>("ServiceInfoID", serviceInfoId));
                           var serviceDateId = sqlH.ExecuteNonQuery(tran, CommandType.StoredProcedure, "usp_Aspx_AddServicesItem]", parameter, "ServiceDateID");
                           ...
                           foreach (var serviceTimeInfo in serviceDateInfo.ServiceTime)
                           {
                               ...
                               sqlH.ExecuteNonQuery(tran, CommandType.StoredProcedure, "usp_Aspx_AddServicesItem", parameter);
       ...
       public static List<ServiceItemInfo> GetServiceItemInfo(AspxCommonInfo aspxCommonObj, int categoryId)
       {
           ...
           serviceInfo = sqlH.ExecuteAsList<ServiceItemInfo>("usp_Aspx_GetServiceItemInfo", parameter);
           parameter.Remove(new KeyValuePair<string, object>("Option", "serviceInfo"));
           ...
           foreach (var serviceItemInfo in serviceInfo)
           {
               ...
               parameter.Add(new KeyValuePair<string, object>("Option", "serviceEmployeeData"));
               parameter.Add(new KeyValuePair<string, object>("ServiceID", serviceItemInfo.ServiceId));
               serviceEmployeeDataInfo = sqlH.ExecuteAsList<ServiceEmployeeInfo>("usp_Aspx_GetServiceItemInfo", parameter);
               ...
               foreach (var serviceEmployeeInfo in serviceEmployeeDataInfo)
               {
                   ...
                   serviceDateInfo = sqlH.ExecuteAsList<ServiceDateInfo>("usp_Aspx_GetServiceItemInfo", parameter);
                   ...
                   foreach (var dateInfo in serviceDateInfo)
                   {
                       ...
                       parameter.Add(new KeyValuePair<string, object>("ServiceEmployeeID", serviceEmployeeInfo.ServiceEmployeeId));
                       servicTimeInfo = sqlH.ExecuteAsList<ServiceTimeInfo>("usp_Aspx_GetServiceItemInfo", parameter);
       ...
       public static void DeleteServiceItem(string option, AspxCommonInfo aspxCommonObj, int id)
       {
           try
           {
               ...
               OracleHandler sqlH = new OracleHandler();
               sqlH.ExecuteNonQuery("usp_Aspx_DeleteServiceItem", parameter);
           }
           catch (Exception e)
           {
               throw e;
       ...
       public static void DeleteAppointment(string appointmentID, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               OracleHandler sqlh = new OracleHandler();
               sqlh.ExecuteNonQuery("usp_Aspx_DeleteAppointment", parameter);
           }
           catch (Exception e)
           {
               throw e;
       ...
       public static List<BookAppointmentInfo> GetAppointmentDetailByID(int appointmentID, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               parameter.Add(new KeyValuePair<string, object>("AppointmentID", appointmentID));
               OracleHandler sqlh = new OracleHandler();
               List<BookAppointmentInfo> lstBookAppoint= sqlh.ExecuteAsList<BookAppointmentInfo>("usp_Aspx_GetAppointmentDetailByID", parameter);
               return lstBookAppoint;
           }
           catch (Exception e)
           {
       ...
       public static List<AppointmentStatusInfo> GetAppointmentStatusList(AspxCommonInfo aspxCommonObj)
       {
           try
           {
               List<KeyValuePair<string, object>> parameter = CommonParmBuilder.GetParamSPC(aspxCommonObj);
               OracleHandler sqlh = new OracleHandler();
               List<AppointmentStatusInfo> lstAppointStatus= sqlh.ExecuteAsList<AppointmentStatusInfo>("usp_Aspx_GetAppointmentStatusList", parameter);
       ...
       public static void AddUpdateAppointmentStatus(AspxCommonInfo aspxCommonObj, AppointmentSatusInfoBasic statusObj)
       {
           try
           {
               ...
               OracleHandler sqlh = new OracleHandler();
               sqlh.ExecuteNonQuery("usp_Aspx_AppointmentStatusAddUpdate", parameter);
           }
           catch (Exception ex)
           {
       ...
       public static List<ServiceProviderInfo> GetServiceProviderNameList(AspxCommonInfo aspxCommonObj, int storeBranchId)
       {
           try
           {
               ...
               OracleHandler sqlh = new OracleHandler();
               List<ServiceProviderInfo> lstServProv= sqlh.ExecuteAsList<ServiceProviderInfo>("usp_Aspx_GetServiceProviderNameList", parameter);
               return lstServProv;
           }
           catch (Exception e)
           {
       ...
       public static void DeleteServiceProvider(AspxCommonInfo aspxCommonObj, string id, int storeBranchId)
       {
           try
           {
               ...
               OracleHandler sqlh = new OracleHandler();
               sqlh.ExecuteNonQuery("usp_Aspx_DeleteProviderFrmBranch", parameter);
           }
           catch (Exception e)
           {
               throw e;
       ...
       public static List<ServiceGridListInfo> GetAllServiceList(int offset, int limit, AspxCommonInfo aspxCommonObj, string serviceName, string branchName)
       {
           try
           {
               ...
               parameter.Add(new KeyValuePair<string, object>("BranchName", branchName));
               OracleHandler sqlh = new OracleHandler();
               List<ServiceGridListInfo> list = sqlh.ExecuteAsList<ServiceGridListInfo>("usp_Aspx_GetServiceList", parameter);
               return list;
           }
           catch (Exception e)
           {
       ...
       public List<ServiceBookedTime> GetServiceBookedTime(GetServiceBookedTimeInfo bookedTimeObj, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               OracleHandler sqlh = new OracleHandler();
               List<ServiceBookedTime> lstSBTime = sqlh.ExecuteAsList<ServiceBookedTime>("usp_Aspx_GetServiceBookedTime", parameter);
               return lstSBTime;
           }
           catch (Exception e)
           {
       ...
       public static List<OrderServiceDetailInfo> GetServiceDetailsByOrderID(int orderID, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               OracleHandler sqlh = new OracleHandler();
               List<OrderServiceDetailInfo> lstBookAppoint = sqlh.ExecuteAsList<OrderServiceDetailInfo>("usp_Aspx_GetServiceDetailsByOrderID", parameter);
               return lstBookAppoint;
           }
           catch (Exception e)
           {
       ...
       public static List<BookAppointmentInfo> GetAppointmentDetailsForExport( AspxCommonInfo aspxCommonObj)
       {
           try
           {
               List<KeyValuePair<string, object>> parameter = CommonParmBuilder.GetParamSPUC(aspxCommonObj);
               OracleHandler sqlh = new OracleHandler();
               List<BookAppointmentInfo> lstBookAppoint = sqlh.ExecuteAsList<BookAppointmentInfo>("usp_Aspx_GetAppointmentDetailsForExport", parameter);
               return lstBookAppoint;
           }
           catch (Exception e)
           {
       ...
       public static List<StoreLocatorInfo> GetAllStoresForService(AspxCommonInfo aspxCommonObj, int? serviceCategoryId)
       {
           ...
           {
               OracleHandler sqlH = new OracleHandler();
               List<StoreLocatorInfo> lstStoreLocator = sqlH.ExecuteAsList<StoreLocatorInfo>("usp_Aspx_GetAllStoreForService", parameterCollection);
