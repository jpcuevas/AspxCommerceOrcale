...
{
    public class BookAnAppointmentInfo
    {
        ...
        public int PreferredTimeId
        {
            get;
            set;
        }

        public string PreferredTimeInterval
        {
            get;
            set;
        }
        ...
        public string ServiceProductPrice
        {
            get;
            set;
        }
