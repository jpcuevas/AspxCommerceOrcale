...
namespace SageFrame.Security.Providers
{
    public class MembershipDataProvider
    {
        ...
        {
            string sp = "usp_PortalUserListGet";
            ...
            try
            {
                ...
                reader = orasql.ExecuteAsDataReader(sp, ParamCollInput);
                while (reader.Read())
                {
                    UserInfo obj = new UserInfo();
                    obj.UserID = new Guid(reader["UserID"] as byte[]);
        ...
        public static SageFrameUserCollection GetAllUsers()
        {
            ...
            try
            {
                ...
                reader = orasql.ExecuteAsDataReader(sp);
                while (reader.Read())
                {
                    UserInfo obj = new UserInfo();
                    obj.UserID = new Guid(reader["userid"].ToString());
        ...
        {
            string sp = "usp_SageFrameUserListSearch";
            SageFrameSQLHelper sagesql = new SageFrameSQLHelper();
        ...
        {
            string sp = "usp_UserModuleIsEditAllowed";
            //SQLHandler sagesql = new SQLHandler();
            OracleHandler orasql = new OracleHandler();
            try
            {
                ...
                ParamCollInput.Add(new KeyValuePair<string, object>("PortalID", PortalID));
                ParamCollInput.Add(new KeyValuePair<string, object>("UserName", UserName));
                int count = orasql.ExecuteAsScalar<int>(sp, ParamCollInput);
        ...
        public static void CreateRole(RoleInfo obj, out RoleCreationStatus status)
        {
            ...
            try
            {
                SageFrameSQLHelper sagesql = new SageFrameSQLHelper();
                List<KeyValuePair<int, string>> OutputValColl = new List<KeyValuePair<int, string>>();
                OutputValColl = sagesql.ExecuteNonQueryWithMultipleOutput("usp_sf_CreateRole", ParamCollInput, ParamCollOutput);
                int ErrorCode = int.Parse(OutputValColl[0].Value);
        ...
        {
            string sp = "usp_PortalRoleDelete";
            //SQLHandler sagesql = new SQLHandler();
            OracleHandler orasql = new OracleHandler();
            try
            {
        ...
        {
            string sp = "usp_RoleNamesGetByUserName";
            //SQLHandler sagesql = new SQLHandler();
            OracleHandler orasql = new OracleHandler();

            List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
            ParamCollInput.Add(new KeyValuePair<string, object>("v_UserName", UserName));
            ParamCollInput.Add(new KeyValuePair<string, object>("v_PortalID", PortalID));
            OracleDataReader reader = null;
            try
            {
        ...
        public static bool SaveSettings(List<SettingInfo> lstSetting)
        {
            ...
            try
            {
                foreach (SettingInfo obj in lstSetting)
                {
                    ...
                    orasql.ExecuteNonQuery(sp, ParamCollection);
                }
        ...
        {
            string sp = "usp_sf_UserInRolesAdd";
            SageFrameSQLHelper sagesql = new SageFrameSQLHelper();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        {
            string sp = "usp_sf_UserInRolesDelete";
            SageFrameSQLHelper sagesql = new SageFrameSQLHelper();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        {
            string sp = "usp_ChangeUserInRoles";
            SageFrameSQLHelper sagesql = new SageFrameSQLHelper();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        {
            string sp = "usp_sf_ResetPassword";
            SageFrameSQLHelper sagesql = new SageFrameSQLHelper();
        ...
        public static UserInfo GerUserByEmail(string email, int portalID)
        {
            ...
            try
            {
                ...
                UserInfo objUser = orasql.ExecuteAsObject<UserInfo>(sp, ParamCollInput);
                return objUser;
            }
            catch (Exception)
            {
