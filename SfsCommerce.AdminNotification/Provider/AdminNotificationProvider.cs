    ...
    public class AdminNotificationProvider
    {
        ...
        public static void NotificationSaveUpdateSettings(NotificationSettingsInfo saveUpdateInfo, AspxCommonInfo aspxCommonObj)
        {
            try
            {
                ...
                sqlH.ExecuteNonQuery("usp_Aspx_NotificationSaveUpdateSettings", parameterCollection);
        ...
        public static NotificationSettingsInfo NotificationSettingsGetAll(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                ...
                OracleHandler sqlH = new OracleHandler();
                NotificationSettingsInfo listInfo = sqlH.ExecuteAsObject<NotificationSettingsInfo>("usp_Aspx_NotificationSettingsGetAll", parameterCollection);
                return listInfo;
            }
            catch (Exception e)
            {
        ...
        public static NotificationGetAllInfo NotificationGetAll(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                ...
                OracleHandler sqlH = new OracleHandler();
                NotificationGetAllInfo listInfo = sqlH.ExecuteAsObject<NotificationGetAllInfo>("usp_Aspx_NotificationGetAll", parameterCollection);
                return listInfo;
            }
            catch (Exception e)
            {
        ...
        public static List<OutOfStockInfo> NotificationitemsGetAll(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                ...
                OracleHandler sqLH = new OracleHandler();
                DataSet ds = sqLH.ExecuteAsDataSet("usp_Aspx_NotificationItemsGetAll", parameterCollection);
        ...
        public static List<NotificationOrdersInfo> NotificationOrdersGetAll(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                List<KeyValuePair<string, object>> parameterCollection = CommonParmBuilder.GetParamSPC(aspxCommonObj);
                OracleHandler sqlH = new OracleHandler();
                List<NotificationOrdersInfo> listInfo = sqlH.ExecuteAsList<NotificationOrdersInfo>("usp_Aspx_NotificationOrdersGetAll", parameterCollection);
                return listInfo;
            }
            catch (Exception e)
            {
