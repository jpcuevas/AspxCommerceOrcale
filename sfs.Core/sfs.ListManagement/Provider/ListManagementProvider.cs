    ...
    public class ListManagementProvider
    {
        ...
        public List<ListManagementInfo> GetListEntriesByNameParentKeyAndPortalID(string ListName, string ParentKey, int PortalID, string Culture)
        {
            try
            {
                ...
                return SQLH.ExecuteAsList<ListManagementInfo>("sp_GetListEntriesByNameParentKeyAndPortalID", ParamCollInput);
            }
            catch (Exception ex)
            {
        ...
        {
            string sp = "sp_ListEntryDeleteByID";
            OracleHandler sagesql = new OracleHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        public void SortList(int EntryId, bool MoveUp, string Culture)
        {
            ...
            string sp = "sp_ListSortOrderUpdate";
            OracleHandler sagesql = new OracleHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        public ListManagementInfo GetListEntryDetails(string ListName, string Value, int EntryID, string Culture)
        {
            ...
            try
            {
                ...
                reader = SQLH.ExecuteAsDataReader("sp_GetListEntrybyNameValueAndEntryID", ParamCollInput);
        ...
        public List<ListManagementInfo> GetListEntriesByNameValueAndEntryID(string ListName, string Value, int EntryID, string Culture)
        {
            try
            {
                ...
                return SQLH.ExecuteAsList<ListManagementInfo>("sp_GetListEntrybyNameValueAndEntryID", ParamCollInput);
        ...
        public List<ListManagementInfo> GetEntriesByNameParentKeyAndPortalID(string ListName, string ParentKey, int PortalID, string Culture)
        {
            ...
            try
            {
                ...
                reader = SQLH.ExecuteAsDataReader("sp_GetListEntriesByNameParentKeyAndPortalID", ParamCollInput);
        ...
        public List<ListManagementInfo> GetListEntrybyNameAndID(string ListName, int EntryID, string Culture)
        {
            try
            {
                ...
                ParamCollInput.Add(new KeyValuePair<string, object>("EntryID", EntryID));
                ParamCollInput.Add(new KeyValuePair<string, object>("Culture", Culture));
                return SQLH.ExecuteAsList<ListManagementInfo>("sp_GetListEntrybyNameAndID", ParamCollInput);
            }
            catch (Exception ex)
            {
                    ...
                    string _Company, string _Website, string _Message, string _Attachment, bool status, DateTime date, int PortalID, string username)
        {
            try
            {
                ...
                SQLH.ExecuteNonQuery("sp_FeedbackFormAdd", ParamCollInput);
            }
            catch (Exception ex)
            {
        ...
        public DataTable FeedbackItemGet(int PortalID, string CultureName)
        {
            ...
            try
            {
                ...
                return SQLH.ExecuteAsDataSet("sp_FeedbackItemGet", ParamCollInput).Tables[0];
            }
            catch (Exception ex)
            {
        ...
        public string GetFeedbackSettingValueList(int PortalID)
        {
            try
            {
                ...
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
                ParamCollInput.Add(new KeyValuePair<string, object>("PortalID", PortalID));
                return SQLH.ExecuteAsObject<FeedbackSettingInfo>("sp_FeedbackSettingValueList", ParamCollInput).SettingValue;
            }
            catch (Exception ex)
            {
        ...
        public List<ListInfo> GetDefaultList(string CultureName, int PortalID)
        {
            ...
            try
            {
                ...
                OracleHandler sqlH = new OracleHandler();
                List<ListInfo> defaultList = sqlH.ExecuteAsList<ListInfo>("sp_GetDefaultList", ParaMeterCollection);
                return defaultList;
            }
            catch (Exception e)
            {
        ...
        public List<ListInfo> GetListByPortalID(string CultureName, int PortalID)
        {
            ...
            try
            {
                ...
                OracleHandler sqlH = new OracleHandler();
                List<ListInfo> defaultList = sqlH.ExecuteAsList<ListInfo>("sp_GetListsByPortalID", ParaMeterCollection);
                return defaultList;
            }
            catch (Exception e)
            {
        ...
        public List<ListInfo> GetListInfo(string listName, string parentId,int portalID, string cultureName)
        {
            try
            {
                ...
                listParentEntry = sqlH.ExecuteAsList<ListInfo>("sp_GetListEntriesByNameParentKeyAndPortalID", ParaMeterCollection);
        ...
        public DataSet GetListInfoInDataSet(string listName, string parentId, int portalID, string cultureName)
        {
            try
            {
                ...
                ds = sqlH.ExecuteAsDataSet("sp_GetListEntriesByNameParentKeyAndPortalID", ParaMeterCollection);
                return ds;
            }
            catch (Exception e)
            {
        ...
        public List<ListManagementInfo> GetListEntryByParentID(int entryId, string cultureName)
        {
            try
            {
                ...
                objMngInfoLst = sqlH.ExecuteAsList<ListManagementInfo>("sp_GetListEntrybyParentId", ParaMeterCollection);
