    ...
    public class SessionLog
    {
        ...
        public void SessionTrackerUpdateUsername(SessionTracker sessionTracker, string GetUsername, string GetPortalID)
        {
            try
            {
                ...
                ParaMeterCollection.Add(new KeyValuePair<string, string>("SessionTrackerID", sessionTracker.SessionTrackerID));
                ParaMeterCollection.Add(new KeyValuePair<string, string>("UserName", GetUsername));
                ParaMeterCollection.Add(new KeyValuePair<string, string>("PortalID", GetPortalID));
                //SQLHandler sagesql = new SQLHandler();
                OracleHandler sagesql = new OracleHandler();
                //sagesql.ExecuteNonQuery("sp_SessionTrackerUpdateUsername", ParaMeterCollection);
                sagesql.ExecuteNonQuery("sp_SessionTrackerUpdateUsernam", ParaMeterCollection);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public void SessionLogStart(SessionTracker tracker)
        {
            try
            {
                ...
                //SQLHandler sagesql = new SQLHandler();
                OracleHandler sagesql = new OracleHandler();
                int insertedID = sagesql.ExecuteNonQuery("sp_SessionTrackerAdd", ParaMeterCollection, "InsertedID");
        ...
        public void SessionLogEnd(SessionTracker tracker)
        {
            try
            {
                ...
                //SQLHandler sagesql = new SQLHandler();
                OracleHandler sagesql = new OracleHandler();
                sagesql.ExecuteNonQuery("sp_SessionTrackerUpdateEND", ParaMeterCollection);
