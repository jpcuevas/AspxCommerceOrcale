    ...
    public class MenuManagerDataProvider
    {
        public static List<MenuManagerInfo> GetMenuList(string UserName, int PortalID)
        {
            try
            {
                ...
                return SQLH.ExecuteAsList<MenuManagerInfo>("usp_MenuManagerGetMenu", ParamCollInput);
            }
            catch (Exception)
            {
        ...
        {
            string sp = "usp_MenuMgrUpdateMenu";
        ...
        public static List<MenuManagerInfo> GetSageMenuList(string UserName, int UserModuleID, int PortalID)
        {
            try
            {
                ...
                ParamCollInput.Add(new KeyValuePair<string, object>("PortalID", PortalID));
                return SQLH.ExecuteAsList<MenuManagerInfo>("usp_MenuManagerGetSageMenu", ParamCollInput);
            }
            catch (Exception)
            {
        ...
        public static List<MenuManagerInfo> CheckDefaultMenu(int MenuID)
        {
            try
            {
                ...
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
                ParamCollInput.Add(new KeyValuePair<string, object>("MenuID", MenuID));
                return SQLH.ExecuteAsList<MenuManagerInfo>("usp_MenuMgrSelectIsDefault", ParamCollInput);
            }
            catch (Exception)
            {
        ...
        public static List<MenuManagerInfo> GetAllMenuItem(int MenuID)
        {
            try
            {
                ...
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
                ParamCollInput.Add(new KeyValuePair<string, object>("MenuID", MenuID));
                return SQLH.ExecuteAsList<MenuManagerInfo>("usp_MenuMgrGetMenuItem", ParamCollInput);
            }
            catch (Exception)
            {
        ...
        public static List<MenuManagerInfo> GetAllMenuItems(int UserModuleID, int PortalID)
        {
            try
            {
                ...
                ParamCollInput.Add(new KeyValuePair<string, object>("UserModuleID", UserModuleID));
                ParamCollInput.Add(new KeyValuePair<string, object>("PortalID", PortalID));
                return SQLH.ExecuteAsList<MenuManagerInfo>("usp_MenuMgrLoadMenu", ParamCollInput);
            }
            catch (Exception)
            {
        ...
        public static List<MenuManagerInfo> GetSageMenu(int UserModuleID, int PortalID, string UserName)
        {
            try
            {
                ...
                ParamCollInput.Add(new KeyValuePair<string, object>("PortalID", PortalID));
                ParamCollInput.Add(new KeyValuePair<string, object>("UserName", UserName));
                return SQLH.ExecuteAsList<MenuManagerInfo>("usp_MenuMgrLoadSageMenuItems", ParamCollInput);
            }
            catch (Exception)
            {
        ...
        public static List<MenuManagerInfo> GetSageMenu_Localized(int UserModuleID, int PortalID, string UserName, string CultureName)
        {
            try
            {
                ...
                return SQLH.ExecuteAsList<MenuManagerInfo>("usp_MenuMgrLoadSageMenuItems_Localized", ParamCollInput);
            }
            catch (Exception)
            {
        ...
        {
            string sp = "usp_MenuMgrAddSubText";
            OracleHandler sagesql = new OracleHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        {
            string sp = "usp_MenuMgrDeleteMenu";
            OracleHandler sagesql = new OracleHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        public static List<MenuManagerInfo> GetAdminPage(int PortalID, string UserName, string CultureCode)
        {
            ...
            string StoredProcedureName = "usp_SageMenuGetAdminView";
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>();
        ...
        {
            string sp = "usp_MenuMgrAddMenuItem";
            OracleHandler sagesql = new OracleHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        {
            List<MenuManagerInfo> lstPages = new List<MenuManagerInfo>();
            string StoredProcedureName = "usp_MenuMgrGetMenuItemDetails";
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>();
        ...
        public static MenuManagerInfo GetMenuSetting(int PortalID, int MenuID)
        {
            ...
            string StoredProcedureName = "usp_MenuMgrGetSetting";
            OracleHandler sagesql = new OracleHandler();
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>();
            ParaMeterCollection.Add(new KeyValuePair<string, object>("PortalID", PortalID));
        ...
        public static List<MenuPermissionInfo> GetMenuPermission(int PortalID, int MenuID)
        {
            ...
            string StoredProcedureName = "usp_MenuMgrGetPermission";
            OracleHandler sagesql = new OracleHandler();
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>();
            ParaMeterCollection.Add(new KeyValuePair<string, object>("PortalID", PortalID));
            ParaMeterCollection.Add(new KeyValuePair<string, object>("MenuID", MenuID));
        ...
        {
            string sp = "usp_MenuMgrDeleteLink";
            OracleHandler sagesql = new OracleHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        {
            string sp = "usp_SageMenuUpdateSelectedMenu";
            OracleHandler sagesql = new OracleHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
        ...
        public static List<SitemapInfo> GetSiteMapPages(string UserName, string CultureCode)
        {
            ...
            {
                OracleHandler sagesql = new OracleHandler();
                lstPages = sagesql.ExecuteAsList<SitemapInfo>("usp_SEOGetPages");
