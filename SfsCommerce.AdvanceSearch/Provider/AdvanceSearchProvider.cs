    ...
    public class AdvanceSearchProvider
    {
        public List<AdvanceSearchSettingInfo> GetAdvanceSearchSetting(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                ...
                objHDSetting = sqlH.ExecuteAsList<AdvanceSearchSettingInfo>("usp_Aspx_AdvanceSearchSettings", parameterCollection);
                return objHDSetting;
            }
            catch (Exception e)
            {
        ...
        public void SaveAndUpdateAdvanceSearchSetting(AspxCommonInfo aspxCommonObj, AdvanceSearchSettingKeyPairInfo advanceObj)
        {
            try
            {
                ...
                sqlhandle.ExecuteNonQuery("usp_Aspx_AdvanceSearchSettingsUpdate", parameterCollection);
            }
            catch (Exception e)
            {
                throw e;
