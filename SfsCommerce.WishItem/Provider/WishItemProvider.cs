...
namespace AspxCommerce.WishItem
{
    public class WishItemProvider
    {
        ...
        public decimal CountWishItems(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                List<KeyValuePair<string, object>> parameter = CommonParmBuilder.GetParamNoCID(aspxCommonObj);
                OracleHandler sqlH = new OracleHandler();
                decimal countWish = sqlH.ExecuteAsScalar<decimal>("usp_Aspx_GetWishItemsCount", parameter);
                return countWish;
            }
            catch (Exception e)
            {
        ...
        public WishItemsSettingInfo GetWishItemsSetting(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                ...
                objWishSetting = sqlH.ExecuteAsObject<WishItemsSettingInfo>("usp_Aspx_WishItemsSettingsGet", parameterCollection);
        ...
        public void SaveAndUpdateWishItemsSetting(AspxCommonInfo aspxCommonObj, WishItemsSettingKeyPairInfo wishlist)
        {
            try
            {
                ...
                sqlhandle.ExecuteNonQuery("usp_Aspx_WishItemsSettingsUpdate", parameterCollection);
            }
            catch (Exception e)
            {
                throw e;
