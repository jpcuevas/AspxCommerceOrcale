    ...
    public class ModuleDataProvider
    {
        public string AddUserModule(UserModuleInfo module)
        {
            ...
            try
            {
                ...
                resultColl = sqlH.ExecuteNonQueryWithMultipleOutput(tran, CommandType.StoredProcedure, "usp_UserModulesAdd", ParaMeterCollection, ParaMeterInputCollection);
        ...
        public void SetUserModuleInheritedPermission(int PageID, OracleTransaction tran, int UserModuleID, int PortalID, string AddedBy, int ModuleDefID)
        {
            try
            {
        ...
        public static List<UserModuleInfo> GetPageModules(int PageID, int PortalID, bool IsHandheld)
        {
            ...
            string StoredProcedureName = "usp_ModuleManagerGetPageModules";
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>
                                                                         {
                                                                             new KeyValuePair<string, object>(
                                                                                 "PageID", PageID),
        ...
        {
            List<UserModuleInfo> lstUserModules = new List<UserModuleInfo>();
            string StoredProcedureName = "usp_usermodulesgetpagemodules";
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>
                                                                                {
                                                                                    new KeyValuePair<string, object>(
                                                                                        "IsAdmin", IsAdmin)                                                                               
        ...
        public static UserModuleInfo GetUserModuleDetails(int UserModuleID, int PortalID)
        {
            ...
            string StoredProcedureName = "usp_UserModulesGetDetails";
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>
                                                                                {
                                                                                    new KeyValuePair<string, object>(
                                                                                        "UserModuleID", UserModuleID),                                                                                 
        ...
        internal static bool PublishPage(int pageId, bool isPublish)
        {
            try
            {
                ...
                handler.ExecuteNonQuery("usp_PagePublish", para);
                return true;
            }
            catch (Exception ex)
            {
