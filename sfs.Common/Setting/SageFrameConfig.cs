    ...
    public class SageFrameConfig
    {
        ...
        public DataSet GetPageSettings(string controlType, string pageID)
        {
            try
            {
                ...
                ds = sagesql.ExecuteAsDataSet("sp_GetPageSetting", ParaMeterCollection);
                return ds;
            }
            catch (Exception e)
            {
        ...
        public DataSet GetPageSettingsByPageSEOName(string controlType, string pageSEOName, string userName)
        {
            try
            {
                ...
                //SQLHandler sagesql = new SQLHandler();
                OracleHandler sagesql = new OracleHandler();
                ds = sagesql.ExecuteAsDataSet("usp_GetPageSettingByPageSEOName", ParaMeterCollection);
                return ds;
            }
            catch (Exception e)
            {
        ...
        public List<UserModuleInfo> GetPageModules(string controlType, string pageSEOName, string userName, string cultureCode, bool isPreview, string previewCode)
        {
            try
            {
                ...
                OracleHandler sagesql = new OracleHandler();
                //SQLHandler sagesql = new SQLHandler();
                lstPageModules = sagesql.ExecuteAsList<UserModuleInfo>("usp_MasterPageGetPageModules", ParaMeterCollection);
        ...
        public List<UserModuleInfo> GetPageModules_Anonymous(string controlType, string pageSEOName, string userName, string cultureCode)
        {
            ...
            {
                List<KeyValuePair<string, string>> ParaMeterCollection = new List<KeyValuePair<string, string>>();
                ParaMeterCollection.Add(new KeyValuePair<string, string>("v_ControlType", controlType));
                ParaMeterCollection.Add(new KeyValuePair<string, string>("v_PageSEOName", pageSEOName));
                ParaMeterCollection.Add(new KeyValuePair<string, string>("v_PortalID", GetPortalID.ToString()));
                ParaMeterCollection.Add(new KeyValuePair<string, string>("v_UserName", userName));
                ParaMeterCollection.Add(new KeyValuePair<string, string>("v_CultureCode", cultureCode));
                List<UserModuleInfo> lstPageModules = new List<UserModuleInfo>();
                OracleHandler sagesql = new OracleHandler();
                //SQLHandler sagesql = new SQLHandler();
                lstPageModules = sagesql.ExecuteAsList<UserModuleInfo>("usp_MasterPageGetPageModules_A", ParaMeterCollection);
                return lstPageModules;
            }
            catch (Exception e)
            {
        ...
        public List<UserModuleInfo> GetPageModules_Superuser(string controlType, string pageSEOName, string GetUsername, string cultureCode, bool isPreview, string previewCode)
        {
            try
            {
                ...
                //SQLHandler sagesql = new SQLHandler();
                OracleHandler sagesql = new OracleHandler();
                lstPageModules = sagesql.ExecuteAsList<UserModuleInfo>("usp_MasterPageGetPageModules_Superuser", ParaMeterCollection);
                return lstPageModules;
            }
            catch (Exception e)
            {
        ...
        public DataSet GetPageSettingsByPageSEONameForAdmin(string controlType, string pageSEOName, string userName)
        {
            try
            {
                ...
                //SQLHandler sagesql = new SQLHandler();
                OracleHandler sagesql = new OracleHandler();
                //ds = sagesql.ExecuteAsDataSet("usp_GetPageSettingByPageSEONameForAdmin", ParaMeterCollection);
                ds = sagesql.ExecuteAsDataSet("usp_GetPageSetByPageSEONamAdmi", ParaMeterCollection);
            ...
            get
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        flag = Convert.ToBoolean(obj.DecideIsParent(portalID));
        ...
        public string DecideIsParent(int PortalID)
        {
            ...
            try
            {
                ...
                OracleHandler sagesql = new OracleHandler();
                 ...
                 //isparent =   sagesql.ExecuteAsScalar<string>("usp_PortalIsParent", ParaMeterCollection);
                return  sagesql.ExecuteAsScalar<String>("usp_PortalIsParent", ParaMeterCollection);
            }
            catch (Exception)
            {
        ...
        public string GetPortalParentURL(int PortalID)
        {
            ...
            try
            {
                ...
                OracleHandler sagesql = new OracleHandler();
                //SQLHandler sagesql = new SQLHandler();
                return sagesql.ExecuteAsScalar<string>("usp_PortalGetParentURL", ParaMeterCollection);
            }
            catch (Exception)
            {
        ...
        public ApplicationInfo GetApplicationInfo(string applicationName)
        {
            ...
            //SQLHandler sagesql = new SQLHandler();
            OracleHandler sagesql = new OracleHandler();
            ApplicationInfo objAppInfo = sagesql.ExecuteAsObject<ApplicationInfo>("usp_GetApplicationInfo", ParaMeterCollection);
            return objAppInfo;
        }
    }
}