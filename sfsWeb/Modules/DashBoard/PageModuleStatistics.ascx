...
$(function() {
    var PageModuleStatistics = {
        ...
        GetPageName: function() {
            ...
            this.config.data = JSON2.stringify({ IsAdmin: false, PortalID: SageFramePortalID, UserModuleID: PageModuleStatistics.config.userModuleId, UserName: SageFrameUserName, secureToken: SageFrameSecureToken });
        ...
        GetModules: function() {
            ...
            this.config.url = PageModuleStatistics.config.baseURL + this.config.method;
            this.config.data = JSON2.stringify({ PortalID: PageModuleStatistics.config.PortalID, UserModuleID: PageModuleStatistics.config.userModuleId, UserName: SageFrameUserName, secureToken: SageFrameSecureToken });
        ...
        GetGeneralSnapShot: function() {
            ...
            this.config.url = PageModuleStatistics.config.baseURL + this.config.method;
            this.config.data = JSON2.stringify({ IsAdmin: false, PortalID: PageModuleStatistics.config.PortalID, UserModuleID: PageModuleStatistics.config.userModuleId, UserName: SageFrameUserName, secureToken: SageFrameSecureToken });
        ...
        GetUsers: function() {
            ...
            this.config.url = PageModuleStatistics.config.baseURL + this.config.method;
            this.config.data = JSON2.stringify({ PortalID: PageModuleStatistics.config.PortalID, UserModuleID: PageModuleStatistics.config.userModuleId, secureToken: SageFrameSecureToken, UserName: PageModuleStatistics.config.UserName });
