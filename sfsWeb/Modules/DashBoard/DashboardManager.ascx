        ...
        var DashboardMgr = {
            ...
            DeleteIcon: function (IconPath) {
                $.ajax({
                    ...
                    data: JSON2.stringify({ IconPath: IconPath, PortalID: DashboardMgr.config.PortalID, UserModuleID: DashboardMgr.config.userModuleId, UserName: SageFrameUserName, secureToken: SageFrameSecureToken }),
                    dataType: DashboardMgr.config.dataType,
                    success: function (msg) {
                    }
                });
            ...
            LoadSidebarItem: function (sidebaritemid) {
                $.ajax({
                    ...
                    data: JSON2.stringify({ SidebarItemID: parseInt(sidebaritemid), PortalID: DashboardMgr.config.PortalID, UserModuleID: DashboardMgr.config.userModuleId, UserName: SageFrameUserName, secureToken: SageFrameSecureToken }),
                    dataType: DashboardMgr.config.dataType,
                    success: function (msg) {
                        var sidebar = msg.d;
                        var html = '';
            ...
            GetLocalizedMessage: function (culturecode, modulename, messagetype) {
                var message = "";
                var param = JSON2.stringify({ CultureCode: culturecode, ModuleName: modulename, MessageType: messagetype, PortalID: DashboardMgr.config.PortalID, UserModuleID: DashboardMgr.config.userModuleId, UserName: SageFrameUserName, secureToken: SageFrameSecureToken });
                $.ajax({
                    type: DashboardMgr.config.type,
                    contentType: DashboardMgr.config.contentType,
                    cache: DashboardMgr.config.cache,
