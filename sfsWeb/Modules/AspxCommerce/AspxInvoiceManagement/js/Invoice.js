        ...
        BindInvoiceInformation: function (invoiceNum, billToName, statusType) {
            ...
            $("#gdvInvoiceDetails").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxInvoiceManagement, 'Order ID'), name: 'order_id', cssclass: 'cssClassLinkHeader', controlclass: 'cssClassGridLink', coltype: 'link', align: 'left', url: '', queryPairs: '' },
