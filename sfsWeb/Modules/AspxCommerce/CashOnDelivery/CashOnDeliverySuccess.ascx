                    ...
                    case 1:
                        ...
                        $.each(data.d, function (index, value) {
                            ...
                            if (index < 1) {
                                ...
                                billAdd += '<li><h4>' + getLocale(CashOnDelivery, "Billing Address :") + '</h4></li>';
                            ...
                            if (index == 0) {
                                subTotal = '<tr>';
                                subTotal += '<td width="70%" colspan="6">&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(CashOnDelivery, "Sub Total :") + '</b></td>';
                                ...
                                shippingCost = '<tr>';
                                shippingCost += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(CashOnDelivery, "Shipping Cost :") + '</b></td>';
                                ...
                                shippingCost += '</tr>';
                                discountAmount = '<tr>';
                                discountAmount += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(CashOnDelivery, "Discount Amount :") + '</b></td>';
                                ...
                                discountAmount += '</tr>';
                                couponAmount = '<tr>';
                                couponAmount += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(CashOnDelivery, "Coupon Amount :") + '</b></td>';
                                ...
                                rewardAmount = '<tr>';
                                rewardAmount += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(CashOnDelivery, "Discount ( Reward Points ) :") + '</b></td>';
                                ...
                                if (value.GiftCard != "" && value.GiftCard != null) {
                                    ...
                                    for (var g = 0; g < giftCardUsed.length; g++) {
                                        ...
                                        giftCard += '<tr>';
                                        giftCard += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(CashOnDelivery, "Gift Card") + '(' + keyVal[0] +
                                        ') :</b></td>';
                                ...
                                grandTotal += '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td class="cssClassLabel"><b>' + getLocale(CashOnDelivery, "Grand Total :") + '</b></td>';
                        ...
                        if (additionalNote != '' && additionalNote != undefined) {
                            $(".remarks").html("").html(getLocale(CashOnDelivery, "*Additional Note :- ") + "'" + additionalNote + "'");
                        } else {
                            $(".remarks").html("");
                        }
...
<div>
    ...
    <div id="divPageOuter" class="PageOuter">
        ...
        <div id="divPage" class="Page" runat="server">
            ...
            <div id="divReceiptMsg" class="sfLocale cssClassTMar10">
    ...
    <div id="divClickAway" class="cssClassTMar25">
