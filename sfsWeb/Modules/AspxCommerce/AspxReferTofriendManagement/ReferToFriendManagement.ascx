        ...
        <div class="sfGridwrapper">
            <div class="sfGridWrapperContent">
                <div class="cssClassSearchPanel sfFormwrapper">
                    <table width="100%" border="0" cellspacing="0" runat="server" cellpadding="0">
                        <tr>
                            <td>
                ...
                <table id="gdvReferToAFriend" cellspacing="0" cellpadding="0" runat="server" border="0" width="100%">
                </table>
            </div>
        </div>
    </div>
