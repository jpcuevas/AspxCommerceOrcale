    ...
    $(function() {
        ...
        ItemTaxClass = {
            ...
            SaveAndUpdateTaxItemClass: function() {
                ...
                var taxItemClassName = $.trim($("#txtTaxItemClassName").val());

                if ($("#spanError").text() == "Please enter unique tax class name") {
                    return false;
                }
                ...
                if (taxItemClassName != "") {
                    ...
                    this.config.data = JSON2.stringify({ taxItemClassID: taxItemClassId, taxItemClassName: taxItemClassName, aspxCommonObj: aspxCommonObj });
