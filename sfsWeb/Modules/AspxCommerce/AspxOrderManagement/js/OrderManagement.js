                            ...
                            if (index == 0) {
                                ...
                                if (item.IsMultipleShipping != true) {
                                    ...
                                    itemOrderDetails = ' <table cellspacing="0" cellpadding="0" border="0" width="620" style="border: 1px solid #dcdccc;"> <tbody> <tr style="background: #e5e5de;"><td width="50" style="padding: 10px; border-right: 1px solid #dcdccc; padding-left: 5px"> <strong>Item Image</strong> </td> <td width="333" style="padding: 10px; border-right: 1px solid #dcdccc; padding-left: 5px"> <strong>Item Name</strong> </td><td width="46" style="padding: 10px; border-right: 1px solid #dcdccc; padding-left: 5px"> <strong>Price</strong> </td> <td width="89" style="padding: 10px; border-right: 1px solid #dcdccc; padding-left: 5px"> <strong>Qty</strong> </td> <td width="100" style="padding: 10px; padding-left: 5px"> <strong>Line Total</strong> </td> </tr> ';
                                        ...
                                        itemOrderDetails += '<td  style="border-bottom: 1px solid #dcdccc; padding: 5px; border-right: 1px solid #dcdccc; color: #605f5f">' + curSymbol + item.Price.toFixed(2) + '</td>';
                                        ...
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px; border-right: 1px solid #dcdccc; color: #605f5f" >' + curSymbol + item.SubTotal.toFixed(2) + '</td></tr>';
                                    });
                                    if (index == 0) {
                                        ...
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.GrandSubTotal.toFixed(2) + ' </td></tr>';
                                        ...
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.TaxTotal.toFixed(2) + '</td></tr>';
                                        ...
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.ShippingCost.toFixed(2) + '</td></tr>';
                                        ...
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.DiscountAmount.toFixed(2) + '</td></tr>';
                                        ...
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.CouponAmount.toFixed(2) + '</td></tr>';
                                        ...
                                        itemOrderDetails += ' <td style="border-bottom: 1px solid #dcdccc; padding: 5px; border-right: 1px solid #dcdccc; color: #605f5f">' + curSymbol + item.GrandTotal.toFixed(2) + '</td></tr>';
                                    }
                                    ...
                                    if (index == 0) {
                                        ...
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.TaxTotal.toFixed(2) + '</td></tr>';
                                        itemOrderDetails += '<tr><td style="border-bottom: 1px solid #dcdccc; padding: 5px; border-right: 1px solid #dcdccc;">' + getLocale(AspxOrderManagement, 'Shipping Cost ') + '</td>';
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.TotalShippingCost.toFixed(2) + '</td></tr>';
                                        itemOrderDetails += '<tr><td style="border-bottom: 1px solid #dcdccc; padding: 5px; border-right: 1px solid #dcdccc;">' + getLocale(AspxOrderManagement, 'Discount') + '</td>';
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.DiscountAmount.toFixed(2) + '</td></tr>';
                                        itemOrderDetails += '<tr><td style="border-bottom: 1px solid #dcdccc; padding: 5px; border-right: 1px solid #dcdccc;">' + getLocale(AspxOrderManagement, 'Coupon') + ' </td>';
                                        itemOrderDetails += '<td style="border-bottom: 1px solid #dcdccc; padding: 5px;"> ' + curSymbol + item.CouponAmount.toFixed(2) + '</td></tr>';
