<%@ WebHandler Language="C#" Class="AspxCommonHandler" %>
...
public class AspxCommonHandler : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            HttpRequest request = context.Request;
                ...
                ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.Core.AspxCommonController), json, methodName);
