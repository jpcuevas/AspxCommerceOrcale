<%@ WebHandler Language="C#" Class="RewardPointsHandler" %>
...
public class RewardPointsHandler : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
                ...
                ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.Core.AspxRewardPointsController), json, methodName);
