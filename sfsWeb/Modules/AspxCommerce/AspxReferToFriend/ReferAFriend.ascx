    ...
    $(function() {
        ...
        ReferAFriend = {
            ...
            init: function() {
                ...
                var m = $("#EmailForm").validate({
                    ...
                    messages: {
                        yourname: {
                            required: "*",
                            minlength: "" + getLocale(AspxReferToFriend, "(at least 2 chars)") + ""
                        },
            ...
            SaveAndSendEmailSuccess: function() {
                csscody.info("<h2>" + getLocale(AspxReferToFriend, "Successful Message") + "</h2><p>" + getLocale(AspxReferToFriend, "Email has been sent successfully.") + "</p>");
