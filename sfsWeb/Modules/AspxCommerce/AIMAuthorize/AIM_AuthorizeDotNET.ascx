    ...
    <div id="dvCheque" class="cssClassTMar20">
        <ul>
            <li class="cssTextLi">
                ...
                <input id="txtAccountNumber" type="text" name="accountNumber" class=" required" runat="server" minlength="5" />
            </li>
            <li class="cssTextLi NoRmargin">
                <div><span class="sfLocale">Routing Number : </span><span class="cssClassRequired">*</span></div>
                <input id="txtRoutingNumber" type="text" name="routingNumber" class=" required"  runat="server" minlength="9" />
            </li>
            <li class="cssTextLi">
            ...
            <li class="cssTextLi NoRmargin">
                ...
                <input id="txtBankName" type="text" name="bankName" class=" required" runat="server" minlength="2" />
