          ...
          ajaxSuccess: function(msg) {
              switch (WishList.config.ajaxCallMode) {
                  ...
                  case 2:
                      ...
                      break;
                  case 3:
                      HeaderControl.GetWishListCount();                      WishList.GetWishItemList();                      csscody.info("<h2>"+getLocale(AspxWishList,"Successful Message")+"</h2><p>"+getLocale(AspxWishList,"Wished item has been deleted successfully(2).")+"</p>");
                  ...
                  case 4:
                      ...
                      break;
                  case 5:
                      HeaderControl.GetWishListCount();                      WishList.GetWishItemList();
                      break;
                  case 6:
...
//              });
          ...
          BindWishListItems: function(response, index) {
              ...
              if (index % 2 == 0) {
               var  dataContent ='';
                ...
                dataContent+='data-onclick="WishList.AddToCartToJS(' + response.ItemID + "," + response.Price + "," + itemSKU + "," + 1 + '")';               
                if (allowOutStockPurchaseSetting.toLowerCase() == 'false') {
                      if (response.IsOutOfStock) {
                          ...
                          Items += '<span class="cssClassPrice cssClassFormatCurrency">' + parseInt(response.Price).toFixed(2) + '</span></td><td class="cssClassWishComment"><textarea maxlength="300" onkeyup="' + WishList.ismaxlength(this) + '" id="comment_' + response.ItemID + '" class="comment">' + response.Comment + '</textarea></td><td class="cssClassWishDate"><i class="i-calender"></i>' + WishDate + '</td><td class="cssClassWishToCart">';
                          Items += "<div '"+dataContent+"'class='sfButtonwrapper cssClassOutOfStock'><a href=\"#\"><span>"+getLocale(AspxWishList,"Out Of Stock")+"</span></a></div></td>";
                          Items += '<td class="cssClassDelete"><a onclick="WishList.DeleteWishListItem(' + response.ItemID + ')"><i class="i-delete"></i></a></td></tr>';
                          ...
                          Items += "<div '"+dataContent+"' class='sfButtonwrapper'><a href=\"#\" onclick='WishList.AddToCartToJS(" + response.ItemID + "," + response.Price + "," + itemSKU + "," + 1 + ");'><span>"+getLocale(AspxWishList,"Add To Cart")+"</span></a></div></td>";
                          Items += '<td class="cssClassDelete"><a onclick="WishList.DeleteWishListItem(' + response.ItemID + ')"><i class="i-delete"></i></a></td></tr>';
                      }
                  }
                  else {
                  ...
                  if (allowOutStockPurchaseSetting.toLowerCase() == 'false') {
                      if (response.IsOutOfStock) {
                          ...
                          Items += '<a href="' + AspxCommerce.utils.GetAspxRedirectPath() + 'item/' + response.SKU + pageExtension +'">' + response.ItemName + '</a>';
                          Items += '<span class="cssClassPrice cssClassFormatCurrency">' + (response.Price * rate).toFixed(2) + '</span></td><td class="cssClassWishComment"><textarea maxlength="300" onkeyup="' + WishList.ismaxlength(this) + '" id="comment_' + response.ItemID + '" class="comment">' + response.Comment + '</textarea></td><td class="cssClassWishDate">' + WishDate + '</td><td class="cssClassWishToCart">';
                          Items += "<div '"+dataContent+"' class='sfButtonwrapper cssClassOutOfStock'><a href=\"#\"><span>Out Of Stock</span></a></div></td>";
          ...
          SendShareItemEmail: function() {
              ...
              shareWishMailHtml += '  <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>';
                  ...
                  tdContent += '<span style="font-weight:bold; font-size:12px; font-family:Arial, Helvetica, sans-serif; text-shadow:1px 1px 0 #fff;">' + title + '</span>';                  tdContent += '<span style="font-weight:bold; font-size:12px; font-family:Arial, Helvetica, sans-serif; text-shadow:1px 1px 0 #fff;"> <a href="' + serverHostLoc + href + '">' + hrefHtml + '</a></span>';                  tdContent += '<span style="font-weight:bold; font-size:11px; font-family:Arial, Helvetica, sans-serif; text-shadow:1px 1px 0 #fff;">'+getLocale(AspxWishList,"Price:")+'</span> ' + price + '';                  tdContent += '<span style="font-weight:bold; font-size:12px; font-family:Arial, Helvetica, sans-serif; text-shadow:1px 1px 0 #fff;">'+getLocale(AspxWishList,"Comments:")+'</span> ' + htmlComment + '</p></div></td>';                  tdContentArray.push(tdContent);
                  tdContent = '';
