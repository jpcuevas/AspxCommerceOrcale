                        ...
                        <ul>
                            <li>
                                ...
                                <p class="errorMessage">
                                    <span class="cssClassRequired sfLocale">
                                    Enter Valid EmailID with comma separated</span>
                                </p>
                            </li>
                            <li>
...
<script type="text/javascript">
        ...
        var View = function (p) {
            ...
            var WishList = {
                ...
                ajaxCall: function (config) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function (request) {
                            ...
                            request.setRequestHeader("UMID", userModuleIDWishList);
                ...
                BindWishItemSingleDelete: function () {
                    WishItemAPI.Count(); WishList.GetWishItemList(1, $("#ddlWishListPageSize").val(), 0, $("#ddlWishListSortBy option:selected").val()); csscody.info("<h2>" + getLocale(AspxWishItems, "Successful Message") + "</h2><p>" + getLocale(AspxWishItems, "Wished item has been deleted successfully.") + "</p>");
                },
                    ...
                    if (index % 2 == 0) {
                            ...
                            if (p.AllowOutStockPurchaseSetting.toLowerCase() == 'false') {
                                if (response.IsOutOfStock) {
                                    if (response.ItemTypeID == 5) {
                                        Items += "<td class='cssClassWishToCart'><p class='cssClassGroupPriceWrapper'>" + getLocale(AspxWishItems, "Starting At ") + "<span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span></p><div " + dataContent + " class='sfButtonwrapper cssClassOutOfStock'><a href=\"#\"><span>" + getLocale(AspxWishItems, "Out Of Stock") + "</span></a></div></td>";
                                    }
                                    else {
                                        Items += "<td class='cssClassWishToCart'><span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span><div " + dataContent + " class='sfButtonwrapper cssClassOutOfStock'><a href=\"#\"><span>" + getLocale(AspxWishItems, "Out Of Stock") + "</span></a></div></td>";
                                    }
                                }
                                else {
                                    if (response.ItemTypeID == 5) {
                                        Items += "<td class='cssClassWishToCart'><p class='cssClassGroupPriceWrapper'>" + getLocale(AspxWishItems, "Starting At ") + "<span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span></p><div " + dataContent + " class='sfButtonwrapper'><label class='icon-cart cssClassCartLabel cssClassGreenBtn'><button type=\"button\" class=\"addtoCart sfBtn\" addtocart=\"addtocart" + response.ItemID + "\" onclick='AspxCommerce.RootFunction.AddToCartFromJS(" + response.ItemID + "," + parseFloat(response.Price).toFixed(2) + "," + JSON2.stringify(response.SKU) + "," + 1 + "," + "\"" + response.ItemCostVariantValue + "\"" + "," + "this);'><span>" + getLocale(AspxWishItems, "Cart +") + "</button></label></div></td>";
                                    }
                                    else {
                                        Items += "<td class='cssClassWishToCart'><span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span><div " + dataContent + " class='sfButtonwrapper'><label class='icon-cart cssClassCartLabel cssClassGreenBtn'><button type=\"button\" class=\"addtoCart sfBtn\" addtocart=\"addtocart" + response.ItemID + "\" onclick='AspxCommerce.RootFunction.AddToCartFromJS(" + response.ItemID + "," + parseFloat(response.Price).toFixed(2) + "," + JSON2.stringify(response.SKU) + "," + 1 + "," + "\"" + response.ItemCostVariantValue + "\"" + "," + "this);'><span>" + getLocale(AspxWishItems, "Cart +") + "</button></label></div></td>";
                                    }
                                }
                            }
                            else {
                                if (response.ItemTypeID == 5) {
                                    Items += "<td class='cssClassWishToCart'><p class='cssClassGroupPriceWrapper'>" + getLocale(AspxWishItems, "Starting At ") + "<span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span></p><div " + dataContent + "class='sfButtonwrapper'><label class='icon-cart cssClassCartLabel cssClassGreenBtn'><button type=\"button\" class=\"addtoCart\" addtocart=\"addtocart" + response.ItemID + "\" onclick='AspxCommerce.RootFunction.AddToCartFromJS(" + response.ItemID + "," + parseFloat(response.Price).toFixed(2) + "," + JSON2.stringify(response.SKU) + "," + 1 + "," + "\"" + response.ItemCostVariantValue + "\"" + "," + "this);'><span>" + getLocale(AspxWishItems, "Cart +") + "</span></button></label></div></td>";
                                }
                                else {
                                    Items += "<td class='cssClassWishToCart'><span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span><div " + dataContent + "class='sfButtonwrapper'><label class='icon-cart cssClassCartLabel cssClassGreenBtn'><button type=\"button\" class=\"addtoCart\" addtocart=\"addtocart" + response.ItemID + "\" onclick='AspxCommerce.RootFunction.AddToCartFromJS(" + response.ItemID + "," + parseFloat(response.Price).toFixed(2) + "," + JSON2.stringify(response.SKU) + "," + 1 + "," + "\"" + response.ItemCostVariantValue + "\"" + "," + "this);'><span>" + getLocale(AspxWishItems, "Cart +") + "</span></button></label></div></td>";
                                }
                            }
                        }
                        Items += "<td class='cssClassDelete'><a onclick='WishItem.Delete(" + response.WishItemID + ")'><i class='i-delete'></i></a></td></tr>";
                    }
                    else {
                        ...
                        if (p.AllowAddToCart.toLowerCase() == 'true') {
                            if (p.AllowOutStockPurchaseSetting.toLowerCase() == 'false') {
                                if (response.IsOutOfStock) {
                                    if (response.ItemTypeID == 5) {
                                        Items += "<td class='cssClassWishToCart'><p class='cssClassGroupPriceWrapper'>" + getLocale(AspxWishItems, "Starting At ") + "<span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span><div " + dataContent + " class='sfButtonwrapper cssClassOutOfStock'><a href=\"#\"><span>" + getLocale(AspxWishItems, "Out Of Stock") + "</span></p></a></div></td>";
                                    }
                                    else {
                                        Items += "<td class='cssClassWishToCart'><span class='cssClassPrice cssClassFormatCurrency'>" + parseInt(response.Price).toFixed(2) + "</span><div " + dataContent + " class='sfButtonwrapper cssClassOutOfStock'><a href=\"#\"><span>" + getLocale(AspxWishItems, "Out Of Stock") + "</span></a></div></td>";
                                    }
                ...
                SendShareItemEmail: function () {
                    ...
                    $('#tblWishItemList tbody tr').each(function () {
                        if ($(this).find('td input[type="checkbox"]').prop('checked') == true) {
                            itemId += $(this).prop("id").replace(/[^0-9]/gi, '') + ',';
                        }
                    });
                ...
                Init: function () {
                    if (p.EnableWishListSetting.toLowerCase() == 'true') {
                        ...
                        csscody.alert('<h2>' + getLocale(AspxWishItems, "Information Alert") + '</h2><p>' + getLocale(AspxWishItems, "WishList is not enabled.") + '</p>');
                    }
                }
            };
            WishList.Init();
    ...
    $(function () {
        ...
        $(this).WishItem({
            ...
            EnableWishListSetting: '<%=EnableWishList %>',
