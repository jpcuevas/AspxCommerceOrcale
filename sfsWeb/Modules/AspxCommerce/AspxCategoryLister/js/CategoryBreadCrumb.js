...
$(function() {
    ...
    Breadcrum = {
        ...
        getBreadcrum: function () {
            ...
            var cat = applicationPath.split('/');            cat = cat.clean("");
            $('#breadcrumb ul').html('');
            if (cat.length > 1) {
                if (cat[1] == 'category') {
                    var x = cat[2];
                    ...
                    if (AspxCommerce.utils.IsUserFriendlyUrl()) {
                        $('#breadcrumb ul').append('<li class="first"><a href=' + AspxCommerce.utils.GetAspxRedirectPath() + 'Home.aspx' + ' class="i-home">' + getLocale(AspxCategoryLister, 'Home') + '</a></li>');
                    } else {
                        $('#breadcrumb ul').append('<li class="first"><a href=' + AspxCommerce.utils.GetAspxRedirectPath() + 'Home' + ' class="i-home">' + getLocale(AspxCategoryLister, 'Home') + '</a></li>');
                    }
        ...
        getSageBreadcrum: function (itmName) {
            debugger;
                       Breadcrum.config.method = "AspxCommonHandler.ashx/GetBreadCrumb";
                ...
                if (data.d.length > 0) {
                    ...
                    $.each(data.d, function(index, item) {
                        if (index != len)
                            if (index == 0) {
                            if (AspxCommerce.utils.IsUserFriendlyUrl()) {
                                $('#breadcrumb ul').append('<li class="first"><a href=' + AspxCommerce.utils.GetAspxRedirectPath() + 'Home' + pageExtension + ' class="i-home">' + 'Home' + '</a></li>');
                            } else {
                                $('#breadcrumb ul').append('<li class="first"><a href=' + AspxCommerce.utils.GetAspxRedirectPath() + 'Home' + ' class="i-home">' + 'Home' + '</a></li>');
                            }
                        } else {
                            if (AspxCommerce.utils.IsUserFriendlyUrl()) {
                        ...
                        if (index == len) {
                            ...
                            $('#breadcrumb ul').append('<li>' +fixedDecodeURIComponent(item.TabPath) + '</li>');
                        }
        ...
        getCategoryOnly: function(itmName) {
            ...
            Breadcrum.config.method = "AspxCommonHandler.ashx/GetCategoryName";
            Breadcrum.config.url = Breadcrum.config.baseURL + Breadcrum.config.method;
            Breadcrum.config.data = JSON2.stringify({ name: itmName, commonInfo: aspxCommonObj() });
        ...
        BindGetCategoryOnly: function(data) {
            if (data.d.length > 0) {
                ...
                $.each(data.d, function(index, item) {
                    if (index != len)
                        if (AspxCommerce.utils.IsUserFriendlyUrl()) {
                        $('#breadcrumb ul').append('<li><a href=' + AspxCommerce.utils.GetAspxRedirectPath() + 'category/' + fixedEncodeURIComponent(item.TabPath) + pageExtension + ' >' + item.TabPath + '</a></li>');
                    } else {
                        $('#breadcrumb ul').append('<li ><a href=' + AspxCommerce.utils.GetAspxRedirectPath() + 'category/' + fixedEncodeURIComponent(item.TabPath) + ' >' + item.TabPath + '</a></li>');
                    }
                    if (index == len) {
        ...
        getCategory: function(itmName) {
            itmName = fixedDecodeURIComponent(itmName);
            Breadcrum.config.method = "AspxCommonHandler.ashx/GetItemCategories";
            Breadcrum.config.url = Breadcrum.config.baseURL + Breadcrum.config.method;
