...
<div id="divProceed" class="cssClassdivProceed">
    <label class="cssClassDarkBtn i-arrow-left"><button type="submit" id="btnGoBack" class="cssClassbtnGoBack">
        <span class="sfLocale">Go Back</span></button></label>
    <label class="cssClassGreenBtn i-arrow-right"><button type="submit" id="btnProceedReturn" class="cssClassbtnProceedReturn">
