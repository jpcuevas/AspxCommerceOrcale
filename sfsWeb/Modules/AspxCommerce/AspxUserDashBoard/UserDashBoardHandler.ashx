<%@ WebHandler Language="C#" Class="UserDashBoardHandler" %>
...
public class UserDashBoardHandler : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
                ...
                ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.Core.AspxUserDashController), json, methodName);
