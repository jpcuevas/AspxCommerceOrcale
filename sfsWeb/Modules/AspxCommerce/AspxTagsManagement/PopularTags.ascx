    ...
    <div class="cssClassCommonBox Curve">
        ...
        <div class="sfGridwrapper">
            <div class="sfGridWrapperContent">
                ...
                <table id="gdvShowPopulatTagsDetails" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0">
                </table>
                <table id="ShowPopularTagDetailsExportTbl" runat="server" width="100%" border="0" cellpadding="0"
