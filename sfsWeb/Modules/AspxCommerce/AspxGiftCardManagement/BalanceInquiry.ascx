...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        $.extend($.validator, {
            ...
            messages: {
                required: getLocale(CoreJsLanguage, "This field is required."),
                remote: getLocale(CoreJsLanguage, "Please fix this field."),
                email: getLocale(CoreJsLanguage, "Please enter a valid email address."),
                url: getLocale(CoreJsLanguage, "Please enter a valid URL."),
                date: getLocale(CoreJsLanguage, "Please enter a valid date."),
                dateISO: getLocale(CoreJsLanguage, "Please enter a valid date (ISO)."),
                //dateDE: "Bitte geben Sie ein gültiges Datum ein.",
                number: getLocale(CoreJsLanguage, "Please enter a valid number."),
                //alphaNumberic: getLocale(CoreJsLanguage, "Please enter alpha numeri"),
                // numberDE: "Bitte geben Sie eine Nummer ein.",
                digits: getLocale(CoreJsLanguage, "Please enter only digits"),
                creditcard: getLocale(CoreJsLanguage, "Please enter a valid credit card number."),
                equalTo: getLocale(CoreJsLanguage, "Please enter the same value again."),
                //accept: getLocale(CoreJsLanguage, "Please enter a value with a valid extension."),
                maxlength: $.validator.format(getLocale(CoreJsLanguage, "Please enter no more than {0} characters.")),
                minlength: $.validator.format(getLocale(CoreJsLanguage, "(at least {0} characters.)")),
                rangelength: $.validator.format(getLocale(CoreJsLanguage, "Please enter a value between {0} and {1} characters long.")),
                range: $.validator.format(getLocale(CoreJsLanguage, "Please enter a value between {0} and {1}.")),
                max: $.validator.format(getLocale(CoreJsLanguage, "Please enter a value less than or equal to {0}.")),
                min: $.validator.format(getLocale(CoreJsLanguage, "Please enter a value greater than or equal to {0}."))
            },
    ...
    (function ($) {
        $.fn.DigitDecimalAndNegative = function (value, element) {
            var digitDecimal = $(value);
            return digitDecimal.keypress(function (e) {
                //$(this).attr("maxlength",maxValue);
                if (e.which != 8 && e.which != 0 && e.which != 46 && e.which != 31 && (e.which < 48 || e.which > 57)) {
                ...
                $ajaxCall("CheckGiftCardBalance", param, function (data) {
                    ...
                    if (data.d.length > 0) {
                        ...
                        $.each(data.d.reverse(), function (index, item) {
                            ...
                            tddata += "<td class='cssClassFormatCurrency'>" + item.Deposit.toFixed(2) + "</td>";
                            tddata += "<td class='cssClassFormatCurrency'>" + item.UsedAmount.toFixed(2) + "</td>";
                            tddata += "<td class='cssClassFormatCurrency'>" + item.Balance.toFixed(2) + "</td> </tr>";

                            if (parseInt(index) == 0) {
                                //$('#giftcardAmount').html("Gift Card Amount: " + item.Price);
                                $('#currentBalance').html(getLocale(AspxGiftCardManagement, "Current Balance: ") + "<span class='cssClassFormatCurrency'>" + item.Balance.toFixed(2) + "</span>");
                            }
...
<div class="cssClassCommonBox Curve">
    <div class="cssClassHeader">
        <h2 class="sfLocale">Online Balance Inquiry</h2>
    </div>
    <div class="sfGridwrapper cssClassPad25">
        <p>
            <span><strong class="sfLocale">To check the balance of your Gift Card, please enter its Number and PIN below.</strong></span>
        </p>
        <div class="sfGridWrapperContent cssClassTMar15">
            <div class="sfGridTableWrapper">
                <div class="clearfix cssClassBMar15">
                    <div class="sfCol_20">
                        <span class="sfLocale">Gift Card Code</span><span class="cssClassRequired">*</span>:
                    </div>
                    <div class="sfCol_40">
                ...
                <div class="clearfix">
                    <div class="sfCol_20">
                        <span class="sfLocale">Pin Code</span><span class="cssClassRequired">*</span>:
                    </div>
                    <div class="sfCol_40">
                ...
                <div class="sfButtonwrapper">
                    <label class="cssClassGreenBtn i-arrow-right">
                        <button type="button" id="btnBalanceCheck">
                            <span class="sfLocale">Get Balance</span>
                        </button>
                    </label>
                </div>
                    ...
                    <div id="dvGiftCardStatement" style="display: none;">
                        <div class="sfGridWrapperContent">
                            <div class="cssClassCommonBox Curve">
                                <div class="cssClassHeader">
                                    <h2>
                                        <asp:Label ID="lbl" runat="server" Text="Gift Card History" meta:resourcekey="lblResource1"></asp:Label>
                                    </h2>
                                </div>
                                <table id="inquiryResult" width="100%" border="0" cellspacing="0" cellpadding="0"
                                    class="sfGridTableWrapper">
                                    <tr>
                                        <td></td>
                                    </tr>
                                </table>
