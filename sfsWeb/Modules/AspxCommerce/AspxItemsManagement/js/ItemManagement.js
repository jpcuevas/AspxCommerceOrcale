...
$(function () {
    ...
    ItemMangement = {
        ...
        init: function () {
            ...
            $("#languageSelect li").click(function () {
                ...
                if (p.EnableRelatedItem == true) {
                    ItemMangement.BindRelatedItemsGrid(itemId, null, null, null, null, aspxCommonInfo);
                }
                if (p.EnableUpSellItem == true) {
                    ItemMangement.BindUpSellItemsGrid(itemId, null, null, null, null, aspxCommonInfo);
                }
                if (p.EnableCrossSellItem == true) {
                    ItemMangement.BindCrossSellItemsGrid(itemId, null, null, null, null, aspxCommonInfo);
                }
                if (itemTypeId == 2) {
            ...
            $('#dynItemForm').on('click', '#btnDelete', function () {
            ...
            var kit = function () {
                ...
                buildSelectedKit = function (selectedKits) {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        $("select.kitpricechanger").find("option[value=0]").attr('value', item.Price);
                ...
                ui = function () {
                    ...
                    itemKitConfig = function () {
                        ...
                        itemKitConfigHtml += "<td><select class='kitpricechanger' ><option value=''>Kit Price</option><option value='1'>Fixed</option></select></td></tr>";
                        ...
                        itemKitConfigHtml += "<td><select class='kitweightchanger' ><option value=''>Kit Weight</option><option value='1'>Fixed</option></select></td></tr>";
                        itemKitConfigHtml += "<tr class='modifyWeight' style='display:none;' ><td>Price:</td>";
                ...
                UIEvents = function () {
                    ...
                    $("body").on("change", ".kitpricechanger", function () {
                        ...
                        if (parseInt($(this).val()) != 1) {
                            ...
                            $(this).parents('tr:eq(0)').next("tr.modifyPrice").find("input[type=text]").val(parseInt($(this).val()))
                        } else {
                    ...
                    $("body").on("change", ".kitweightchanger", function () {
                        ...
                        if (parseInt($(this).val()) != 1) {
                            ...
                            $(this).parents('tr:eq(0)').next("tr.modifyWeight").find("input[type=text]").val(parseInt($(this).val()))
                        } else {
        ...
        GroupPrice: function () {
            ...
            bindGroupPrices = function (pricelist) {
                ...
                $.each(pricelist, function (index, item) {
                    if (index == 0) {
                        frstRw.find("input[type=text]").val(item.Price);
            ...
            fillOrClear = function (fill, trElem, item) {
                ...
                if (fill) {
                    ...
                    $nxtTr.find("input[type=text]").val(item.Price);
        ...
        CreateAccordion: function (attGroup, attributeSetId, itemTypeId, showDeleteBtn) {
            ...
            if (p.EnableRelatedItem == true) {
                quickNavigation += "<li><a class='st_tab' rel='v_tab12' href='#dv_Content_12'>" + getLocale(AspxItemsManagement, "Related Products") + "</a></li>";
            }
            if (p.EnableUpSellItem == true) {
                quickNavigation += "<li><a class='st_tab' rel='v_tab13' href='#dv_Content_13'>" + getLocale(AspxItemsManagement, "Up-sells") + "</a></li>";
            }
            if (p.EnableCrossSellItem == true) {
                quickNavigation += "<li><a class='st_tab' rel='v_tab14' href='#dv_Content_14'>" + getLocale(AspxItemsManagement, "Cross-sells") + "</a></li>";
            }
            if (p.EnableRelatedItem == true) {
                ...
                case 2:
                    ...
                    if (msg.d.length > 0) {
                        ...
                        if ($("#btnAddQuantityDiscount").attr('clicked')) {
                            ...
                            var backButton = $("<button type='button' />");
                ...
                case 3:
                    ...
                    $.each(msg.d, function (index, item) {
                        if (itemTypeId == 2 && $.trim(item.RoleName) == "Anonymous User") {
                            ...
                            groproles += "<label><input type='radio' name='roles' value=" + item.RoleID + " >" + item.RoleName + " </label>";
                        }
