...
<div class="popupbox" id="popuprel">
    ...
    <table border="0" width="100%" runat="server" cellpadding="0" cellspacing="0" id="tblItemDependencies">
        ...
        <tr>
            <td>
                <label id="lblItemDedendencies" runat="server"  class="sfLocale">
                    More Than
                </label>
            ...
            <td>
                <span class="nowrap">
                    <img class="cssClassItemAddRow" runat="server" title="Add empty item"
                        alt="Add empty item" name="add" src="" />&nbsp;
                    <img class="cssClassItemCloneRow" alt="Clone this item"
                        title="Clone this item" runat="server" name="clone" src="" />&nbsp;
                    <img class="cssClassItemDeleteRow"
                        src="" alt="Remove this item" runat="server" name="remove" />&nbsp; </span>
            </td>
        </tr>
    </table>
