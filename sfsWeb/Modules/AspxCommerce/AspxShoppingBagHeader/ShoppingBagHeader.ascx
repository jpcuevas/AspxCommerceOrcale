...
<div id="divMiniShoppingCart" class="cssClassShoppingCart" style="display: none;">
      ...
      <div class="cssClassFloatLeft"> <div id="fullShoppingBag"> <a onclick="if(!this.disabled){ShopingBag.showShoppingCart();};" href="javascript:void(0);" id="lnkShoppingBag" class="cssGreenCart"><i class="i-cart"></i></a>
            </div>
        <div id="emptyShoppingBag"><i class="i-cart cssGreyCart"></i></div>
  </div>
    <div class="cssClassCartInfo">
        <span id="cartItemCount"></span>
        <img id="imgarrow" src="" alt="down" class="sfLocale" title="down" onclick="if(!this.disabled){ShopingBag.showShoppingCart();}" /></div>
</div>
