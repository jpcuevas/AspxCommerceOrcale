...
$(function () {
    ...
    BindAllValue: function (obj) {
        ...
        $("#chkRealTimeCurrency").prop("checked", $.parseJSON(obj.RealTimeCurrency.toLowerCase()))
    ...
    UpdateStoreSettings: function () {
        ...
        settingKeys += 'MainCurrency' + '*' + 'RealTimeCurrency' + '*' + 'AllowRealTimeNotifications' + '*' + 'WeightUnit' + '*' + 'DimensionUnit' + '*' + 'StoreName' + '*' + 'CartAbandonedTime' + '*' + 'TimeToDeleteAbandonedCart'
