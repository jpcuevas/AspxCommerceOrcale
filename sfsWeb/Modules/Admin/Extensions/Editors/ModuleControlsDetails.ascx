...
<%@ Register Src="~/Controls/sectionheadcontrol.ascx" TagPrefix="uc1" TagName="sectionheadcontrol" %>

<%--<%@ Register Src="~/app/SfsEcommerce/Controls/sectionheadcontrol.ascx" TagName="sectionheadcontrol"
    TagPrefix="sfe" %>--%>
<uc1:sectionheadcontrol runat="server" ID="sectionheadcontrol" />
