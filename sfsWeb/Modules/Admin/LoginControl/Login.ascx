...
<%@ Register Src="~/Controls/LoginStatus.ascx" TagPrefix="uc1" TagName="LoginStatus" %>

<%--<%@ Register Src="~/app/SfsEcommerce/Controls/LoginStatus.ascx" TagName="LoginStatus" TagPrefix="uc1" %>--%>
