...
<script language="javascript" type="text/javascript">
    ...
    $(document).ready(function () {
       ...
       // $('#' + '<%=txtBirthDate.ClientID%>').attr('readOnly', 'true');
        ...
        $.validator.addMethod("dateAtLeast10Years", function (value, element) {          
            ...
            var milli = newDate - Date.parse(myDate);
            var milliPerYear = 1000 * 60 * 60 * 24 * 365.26;
            var yearsApart = milli / milliPerYear;
            return yearsApart > 10;
        }, "Minimum age for registration is at least 10 years");
    });
                    ...
                    <table id="tblEditProfile" runat="server" width="100%" style="margin-bottom: 20px; padding-right: 40px;">
                       ...
                       <%-- <tr>
                        ...
                        <tr runat="server">
                            ...
                            <td runat="server">
                                <asp:TextBox runat="server" ID="txtBirthDate" CssClass="sfInputbox date dateAtLeast10Years" meta:resourcekey="txtBirthDateResource1"></asp:TextBox>
                            </td>
                        </tr>
                        <tr runat="server">
                            <td runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMobile" runat="server" CssClass="sfInputbox txtmobile" meta:resourcekey="txtMobileResource1"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <td id="Td9" runat="server">
                            ...
                            <label class="sfLocale sfBtn">Save
                                <asp:Button ID="btnManagePasswordSave" runat="server" ValidationGroup="vgManagePassword"
                                    OnClick="btnManagePasswordSave_Click"/>
                                    </label>
                            </div>
