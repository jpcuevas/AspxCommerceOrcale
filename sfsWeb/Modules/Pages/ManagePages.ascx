                ...
                <div class="divLayoutContainer">
                    ...
                    <div class="sfFormwrapper sfPadding sfMarginbtn sfModuletopwrapper" id="PageHeader">
                        ...
                        <div class="sfLayoutSettingHolder clearfix">
                            ...
                            <div id="Div2" class="sfHandheldswitch" style="display: none">
                                <img alt="" id="imgType3" title="Type3 Layout" src="<%=appPath%>/Administrator/Templates/Default/images/phone.png" />
                            </div>
