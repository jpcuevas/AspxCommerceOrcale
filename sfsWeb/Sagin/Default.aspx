<%@ Page Language="C#" AutoEventWireup="true"  EnableViewState="true" CodeFile="Default.aspx.cs" Inherits="SageFrame.Sagin_Default" %>
            ...
            <asp:Literal ID="languageSetting" runat="server" EnableViewState="false"></asp:Literal>
                ...
                <div id="templateChangeWrapper" class="Off" style="top: -189px;">
                    <div class="templateChange">
                        ...
                        <asp:RadioButtonList viewstate="true" CssClass="sfTableThemeColor"  runat="server" ID="rdTemplate" AutoPostBack="true" OnSelectedIndexChanged="rdTemplate_SelectedIndexChanged">
