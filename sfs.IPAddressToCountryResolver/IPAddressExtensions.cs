...
namespace SageFrame.Framework
{
    public static class IPAddressExtensions
    {
        ...
        private static IList<IPv4Data> ReadInCSVFile()
        {
            ...
            using (GZipStream stream = new GZipStream(Assembly.GetExecutingAssembly().GetManifestResourceStream("sfs.IPAddressToCountryResolver.data.csv.gz"), CompressionMode.Decompress))
            {
